      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <LogoContainer>
              <img src={logo2} style={{ maxHeight: '120px', height: 'auto' }} alt="M Cabinet Design" />
            </LogoContainer>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography variant="h2" sx={{ color: 'secondary.main', mb: 3, fontWeight: 600 }}>
              Get In Touch
            </Typography>
            <ContactItem>
            ...
            <ContactItem>
              <EmailIcon sx={{ color: 'secondary.main', mt: 0.5 }} />
              <Typography variant="body1" sx={{ color: 'secondary.main', lineHeight: 1.8 }}>
            ...
            <ContactItem>
              ...
              <Typography variant="body1" sx={{ color: 'theme.palette.primary.main', lineHeight: 1.8 }}>
                +61 433 131 290
              </Typography>
            </ContactItem>
